@{
    # VP-only control for arena_v4_pilot.psd1, 2026-09-17: identical except the learner is plain
    # checkpoint-212544. Arena pilot text follows:
    # arena_pilot.psd1 on the fixed engine (attacker cannon, flagships,
    # ground, retreat order) with the v4 predictor (guns, survivors, ground, retreat facts).
    # Paired control: vp_v4_control.psd1, same seeds, plain 212544 learner.
    #
    # Original header:
    ...
    #
    #   .\scripts\ppo_train.ps1 -Config .\scripts\vp_v4_control.psd1 -DryRun
    #   .\scripts\ppo_train.ps1 -Config .\scripts\vp_v4_control.psd1

    Bundle = 'D:\Projects\ti4-engine-rs\out\ppo-diplomacy-my-run\checkpoints\checkpoint-212544'
    Pool = 'D:\Projects\ti4-engine-rs\out\pools\full_np8_12_train.json'
    Run = 'D:\Projects\ti4-engine-rs\out\ppo-vp-v4-control-20260917'
