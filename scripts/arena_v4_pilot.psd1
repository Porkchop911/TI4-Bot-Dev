@{
    # Arena v4 pilot, 2026-09-17: arena_pilot.psd1 on the fixed engine (attacker cannon, flagships,
    ...
    #
    #   .\scripts\ppo_train.ps1 -Config .\scripts\arena_v4_pilot.psd1 -DryRun
    #   .\scripts\ppo_train.ps1 -Config .\scripts\arena_v4_pilot.psd1

    Bundle = 'D:\Projects\ti4-engine-rs\out\ppo-diplomacy-my-run\checkpoints\checkpoint-212544-arena-v4'
    Pool = 'D:\Projects\ti4-engine-rs\out\pools\full_np8_12_train.json'
    Run = 'D:\Projects\ti4-engine-rs\out\ppo-arena-v4-pilot-20260917'
