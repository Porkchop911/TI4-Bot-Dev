# M12 — Rules, security, and performance qualification
...
| M12-003 | Rules/specification conformance harness | M02–M11 | Versioned official-rule and accepted-Rust scenarios check state/choices/events/errors per decision with reproducible counterexamples. |
| M12-004 | Tactical rules-boundary campaign | 003 | At least 10,000 generated scenarios; zero unexplained rules/specification violations. |
| M12-005 | Full-game semantic panel | 003 | Representative seeds/rotations/policies/horizons; invariant/golden differences classified and resolved. |
...
| M12-018 | Optimization pass | 017 | Minimum 3x game/decision/fork and 2x training targets achieved without accepted-semantic regression. |
...
| M12-021 | Frontier semantic review | 001–007 | Independent official-rule/Rust-specification and known-difference approval. |
...
All mandatory numeric gates pass, no unexplained rules/specification failure remains, and
independent frontier reviews approve semantics, security, and performance.
