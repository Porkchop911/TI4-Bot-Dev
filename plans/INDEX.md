...
| Order | Plan | Outcome |
|---:|---|---|
| 0 | [M00 — Oracle and baseline](M00_ORACLE_AND_BASELINE.md) | Frozen scope, compatibility corpus, trustworthy benchmarks |
...
| 9 | [M09 — Learned policy](M09_LEARNED_POLICY.md) | Schemas 2–5, features, compatible inference |
| 10 | [M10 — Simulation and training](M10_SIMULATION_AND_TRAINING.md) | Maps, batches, PG training, archives, Parquet |
| 11 | [M11 — TTS bridge](M11_TTS_BRIDGE.md) | Wire-compatible Windows/TTS integration |
| 12 | [M12 — Qualification](M12_QUALIFICATION.md) | Parity, fuzzing, mutation, security, performance |
| 13 | [M13 — Cutover](M13_CUTOVER.md) | Workload-ready release and rollback path |
